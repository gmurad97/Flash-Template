...
const langDictionary = {
    ...
    "aboutus_info_text": {
        az: "Flash şirkəti Amerikada anbar və yükdaşınma xidmətlərinə istənilən biznes üçünetibarlı və sərfəli seçimdir. Delaver ştatında müxtəlif həcmli bağlamaların (e-ticarət)saxlanması üçün “A” klass anbarımız fəaliyyət göstərir. Əlavə olaraq bütün növyüklərin, o cümlədən iri ölçülü və ağır yüklərin ABŞ daxili daşınması üçün özavtomobil parkımız mövcuddur. Geniş tərəfdaşlar şəbəkəsi və fərdiləşdirilmişxidmətlə yükün təhlükəsizliyini və daşınma tələblərinə uyğunluğu təmin edirik.Bağlamaların qəbul zamanı heç bir qarışıqlığın yaranmaması üçün qeydiyyat aparılır,növünə,ölçüsünə (çəkisinə) görə qruplaşdırılır və rəflərə yiğılır. Saxlanılan bağlamalarbaş verə biləcək vəziyyətlərə qarşı sığortalanır. Anbarda və ərazidə daimi videomüşahidə və nəzarət buraxılış məntəqəsi mövcuddur.",
        ...
        ru: "Flash - надежный и экономически выгодный выбор для любого бизнеса, нуждающегося в услугах хранения и транспортировкигрузов в США. Наш склад класса \"А\" расположен в Делавэре и позволяет хранить грузы разного объема, включая грузы изэлектронной коммерции. Кроме того, мы располагаем собственным автопарком для перевозки грузов любого типа, включаякрупногабаритные и тяжеловесные грузы, по всей территории США. Мы гарантируем безопасность грузов и соблюдениетребований к их транспортировке через наш обширный партнерский сет и индивидуальный подход к каждому клиенту. Чтобыизбежать путаницы при приеме грузов, мы регистрируем, группируем и храним их на полках в соответствии с их типом иразмером (весом). Хранимые грузы застрахованы от возможных рисков. Склад и прилегающая территория находятся подпостоянным видеонаблюдением и контролем."
    },
    "counter_employees": {
    ...
    "lending_warehouse_text": {
        az: "Hər növ bağlama üçün sərfəli anbar xidməti və rəqabətli qiymətlər. Ətraflı məlumat almaq üçün bizimlə əlaqə saxlamaginiz xahiş olunur.",
    ...
    "lending_delivery_text": {
        az: "Amerika-nın hər bir nöqtəsinə təhlükəsiz və sürətli yük çatdırılması. Ətraflı məlumat almaq üçün bizimlə əlaqə saxlamaginiz xahis olunur.",
    ...
    "moreinfo_text": {
        az: "Flash şirkəti Amerikada anbar və yükdaşınma xidmətlərilə, biznes sahiblərinin güvənli və sərfəli bir şəkildə məhsullarını saxlamaq və daşınmaq üçün ən yaxşı seçimdir.",
...
for (const langOption of langOptions) {
    langOption.onclick = () => {
        changeLang(langOption.getAttribute("data-lang-opt"))
    };
}