...
const langDictionary = {
    ...
    "aboutus_info_text": {
        az: "Flash şirkəti Amerikada anbar və yükdaşınma xidmətlərinə istənilən biznes üçün etibarlı və sərfəli seçimdir. Delaver ştatında müxtəlif həcmli bağlamaların (e-ticarət) saxlanması üçün “A” klass anbarımız fəaliyyət göstərir. Əlavə olaraq bütün növ yüklərin, o cümlədən iri ölçülü və ağır yüklərin ABŞ daxili daşınması üçün öz avtomobil parkımız mövcuddur. Geniş tərəfdaşlar şəbəkəsi və fərdiləşdirilmiş xidmətlə yükün təhlükəsizliyini və daşınma tələblərinə uyğunluğu təmin edirik. Bağlamaların qəbul zamanı heç bir qarışıqlığın yaranmaması üçün qeydiyyat aparılır, növünə,ölçüsünə (çəkisinə) görə qruplaşdırılır və rəflərə yiğılır. Saxlanılan bağlamalar baş verə biləcək vəziyyətlərə qarşı sığortalanır. Anbarda və ərazidə daimi video müşahidə və nəzarət buraxılış məntəqəsi mövcuddur.",
